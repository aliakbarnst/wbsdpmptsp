    ...
    <div class="row">			  
        <div class="col-lg-10 col-12">
              <div class="box">
                ...
                <!-- /.box-header -->
                <form class="form" method="POST" action="{{ action('Backend\PengaturanController@store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group @error('nama') error @enderror">
                              ...
                              <input type="text" name="nama" value="{{ old('nama') }}" class="form-control" placeholder="Masukan Nama Lengkap Kantor">
                              @error('nama')
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group @error('alamat') error @enderror">
                              ...
                              <input type="text" name="alamat" value="{{ old('alamat') }}" class="form-control" placeholder="Masukan Nama Lengkap Kantor">
                              @error('alamat')
                              <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                              @enderror
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group @error('telpon') error @enderror">
                              ...
                              <input type="text" name="telpon" value="{{ old('telpon') }}" class="form-control" placeholder="Masukan Nama Lengkap Kantor">
                              @error('telpon')
                              <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                              @enderror
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group @error('email') error @enderror">
                              ...
                              <input type="text" name="email" value="{{ old('email') }}" class="form-control" placeholder="Masukan Nama Lengkap Kantor">
                              @error('email')
                              <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                              @enderror
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group @error('latitude') error @enderror">
                              ...
                              <input type="text" name="latitude" value="{{ old('latitude') }}" class="form-control" placeholder="Masukan Latitude Lengkap Kantor">
                              @error('latitude')
                              <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                              @enderror
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group @error('longitude') error @enderror">
                              ...
                              <input type="text" name="longitude" value="{{ old('longitude') }}" class="form-control" placeholder="Masukan Longitude Lengkap Kantor">
                              @error('longitude')
                              <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                              @enderror
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group @error('facebook') error @enderror">
                              ...
                              <input type="text" name="facebook" value="{{ old('facebook') }}" class="form-control" placeholder="Masukan alamat halaman facebook">
                              @error('facebook')
                              <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                              @enderror
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group @error('youtube') error @enderror">
                              ...
                              <input type="text" name="youtube" value="{{ old('youtube') }}" class="form-control" placeholder="Masukan alamat channel youtube">
                              @error('youtube')
                              <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                              @enderror
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group @error('instagram') error @enderror">
                              ...
                              <input type="text" name="instagram" value="{{ old('instagram') }}" class="form-control" placeholder="Masukan alamat profile instagram">
                              @error('instagram')
                              <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                              @enderror
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group @error('twitter') error @enderror">
                              ...
                              <input type="text" name="twitter" value="{{ old('twitter') }}" class="form-control" placeholder="Masukan alamat halaman twitter">
                              @error('twitter')
                              <div class="help-block"><ul role="alert"><li>{{$message}}</li></ul></div>
                              @enderror
                            </div>
