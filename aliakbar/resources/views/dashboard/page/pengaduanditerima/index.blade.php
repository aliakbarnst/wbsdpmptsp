      ...
      <div class="col-12">
          <div class="box">
              <div class="box-header">						
                  ...
                  {{-- <a href="{{ action('Backend\pengaduan-diterimaController@create') }}" class="btn btn-success mb-2 mr-2 float-right"><i class="fa fa-plus" aria-hidden="true"></i> Tambah pengaduan-diterima</a> --}}
              </div>
              <div class="box-body">
...
<script>
    $(document).ready(function(){
           ...
           serverSide: true,
           ajax: {
           url: "{{ url('dashboard/pengaduan-diterima/table') }}",
           },
           columns: [
            ...
            {
                data: 'jabatan_terduga',
                name: 'jabatan_kategori'
            },
            {
            ...
            {
                data: 'perlindungan_fisik',
                name: 'perlindungan_fisik'
            },
            {
                data: 'status',
                name: 'status'
           ...
           function deleteData()
           {
                $('#ModalHapus').on('show.bs.modal', function(e) {
                    ...
                    $('.TombolHapus').on('click',function(e)
                    {
                        ...
                        $.ajax({
                            url:"{{url('dashboard/berita/delete')}}/" + idDelete,
                            type: 'POST',
