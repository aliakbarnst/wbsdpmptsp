      ...
      <div class="col-12">
          <div class="box">
              <div class="box-header">						
                  ...
                  <a href="{{ action('Backend\SliderController@create') }}" class="btn btn-success mb-2 mr-2 float-right"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data</a>
              </div>
              <div class="box-body">
...
<script>
    $(document).ready(function(){
           ...
           serverSide: true,
           ajax: {
           url: "{{ url('dashboard/slider/table') }}",
           },
           columns: [
           ...
           function deleteData()
           {
                $('#ModalHapus').on('show.bs.modal', function(e) {
                    ...
                    $('.TombolHapus').on('click',function(e)
                    {
                        ...
                        $.ajax({
                            url:"{{url('dashboard/slider/delete')}}/" + idDelete,
                            type: 'POST',
