    ...
    <div class="row">			  
        <div class="col-lg-10 col-12">
              <div class="box">
                ...
                <!-- /.box-header -->
                <form class="form" method="POST" action="{{ action('Backend\FaqController@store') }}">
                    @csrf
                    <div class="box-body">
                       <div class="row">
                          <div class="col-md-12">
                            <div class="form-group @error('pertanyaan') error @enderror">
                              ...
                              <textarea rows="5" name="pertanyaan" class="form-control" placeholder="Masukan Pertanyaan yang sering ditanyakan">{{ old('pertanyaan') }}</textarea>
                              @error('nama_bidang')
                        ...
                        <div class="form-group">
                          <label>Jawaban</label>
                          <textarea rows="5" name="jawaban" class="form-control" placeholder="Masukan jawaban dari pertanyaan tersebut">{{ old('jawaban') }}</textarea>
                        </div>
                    </div>
                    <!-- /.box-body -->
