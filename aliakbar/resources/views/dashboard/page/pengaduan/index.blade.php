      ...
      <div class="col-12">
          <div class="box">
              <div class="box-header">						
                  ...
                  <a href="{{ action('Backend\PengaduanController@create') }}" class="btn btn-success mb-2 mr-2 float-right"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Pengaduan</a>
              </div>
              <div class="box-body">
...
<script>
    $(document).ready(function(){
           ...
           serverSide: true,
           ajax: {
           url: "{{ url('dashboard/pengaduan/table') }}",
           },
           columns: [
